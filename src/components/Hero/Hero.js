    ...
    <div style={{ marginBottom:'55%' }}>
      ...
      <LeftSection>
        ...
        <SectionText data-aos='fade-right' style={{color:'#ffff'}}>
          My name is Mateus Zanatti Saraiva and I'm a portuguese 22 year old Computer Science and Engineering student with a big passion for programming and developing ideas from scratch.
        </SectionText>
