  ...
  return (
    <Section style={{ marginBottom: "10%" }} id='skills'>
      ...
      <SectionText data-aos='fade-right'>
        During my college years, I had the opportunity to work with a wide range
        of technologies, both in and out of the classroom. In college, I focused
        mainly on Backend development, so I decided to further my knowledge by
        exploring Frontend technologies such as React. Later on, when I decided
        to pursue a Backend Engineer career path, I had the chance to work with
        other technologies like Golang, AWS, GraphQL, and many more.
      </SectionText>
      <List>
        ...
        <ListItem data-aos='fade-down'>
          ...
          <ListContainer>
            ...
            <ListParagraph>
              Golang, PHP, Python, Java, C, SQL, NoSQL, AWS, GraphQL, New Relic
              and Docker
            </ListParagraph>
          </ListContainer>
        </ListItem>
        ...
        <ListItem data-aos='fade-left'>
          ...
          <ListContainer>
            ...
            <ListParagraph>
              Git, GitHub, Jira, GitLab, Scrum and Kanban
            </ListParagraph>
          </ListContainer>
        </ListItem>
      </List>
